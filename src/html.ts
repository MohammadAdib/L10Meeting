  ...
  return `
    <div class="section-card">
      ...
      <div class="section-body">
        ...
        ${tableHTML('issuesListTable', ['Issue / Obstacle', 'w:130:Raised By', 'w:90:Priority', 'w:110:Status', 'w:80:Time Est.', 'w:90:Next Mtg?', 'w:80:', 'w:30:'])}
...
<div class="top-bar-wrapper">
  <div class="top-bar"${standalone ? ' style="padding-left:0"' : ''}>
    ...
    <div class="top-bar-actions" id="topBarActions" style="opacity:0;pointer-events:none">
      ...
      ${standalone ? `
        <button class="btn-export" id="btnExportExcel" style="display:none">
      ...
      ` : `
        <button class="btn btn-green" id="btnSaveMeeting" style="display:none">Save</button>
